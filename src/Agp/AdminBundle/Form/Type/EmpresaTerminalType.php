...
class EmpresaTerminalType extends AbstractType
{
    protected $options;
    protected $container;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('terminal', 'entity', array(
                  'empty_value' => 'Selecione um terminal',
                  'label' => "Terminal",  
                  'attr' => array('class' => 'chzn-select'),
                  'class' => 'AgpAdminBundle:Terminal',
                  'property' => 'noSerie',
            ))
        ...
        $resolver->setDefaults(array(
            ...
            'validation_groups' => function(FormInterface $form) {
                ...
                if ($data->getTipoVinculo() == TerminalEmpresa::TIPO_TEMPORARIO) {
                    return array("Default", "temporario", "terminal");
                } else {
                    return array("Default", "terminal");
                }
            },
            'error_mapping' => array(
                'dateLegal' => 'dtInicio',
    ...
    {
        return 'agp_adminbundle_empresaTerminaltype';
    }
}
