...
/**
 * Description of EmpresaTerminal
 *
 * @author bondcs
 */
class EmpresaTerminalHandler {
    ...
    public function onSuccess($entity){
        ...
        if($this->estrategia == self::INSERT){
            $empresa = $this->container->get("agp.empresa.manager")->findById($this->options['empresaId']);
    ...
    {
        if (!$this->form){
            $terminalEmpresaType = $this->container->get("agp.empresaTerminal.form.type");
